<%-- 
    Document   : navBar
    Created on : 25 nov. 2023, 17:31:22
    Author     : dgocr
--%>
...
<nav class="bg-white border-gray-200 dark:bg-[#7A4A2F]">
    ...
    <!-- Validaxion Sesion-->
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            ...
            <li>
                <a href="../pages/inicioAlumnoPage.jsp" class="block text-xl py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-[#FFD6BE]" aria-current="page">Inicio</a>
            </li>
            <li>
